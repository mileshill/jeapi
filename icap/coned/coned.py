...
#from temp_variant import Temperature_Variant
...
class CONED:
    ...
    def build_temperature_variant(self):
        ...
        temp_station_query = """select
                ...
                ObservedDate, Year(ObservedDate) as Year,
        ...
        temp_var = Temperature_Variant(ts).build_temp_var()
