...
class RecordWriter:
    ...
    def write(self, fp=None):
        ...
        if self.meter_type == 'INT':    
            ...
            header = 'PREMISEID,RATECLASS,RUNDATE,'\
            'STARTDATE_1,ENDDATE_1,DEMAND_1,SUMMER_CYCLE,BILL_CYCLE,'\
            'STARTDATE_2,ENDDATE_2,DEMAND_2,SUMMER_CYCLE,BILL_CYCLE,'\
            'STARTDATE_3,ENDDATE_3,DEMAND_3,SUMMER_CYCLE,BILL_CYCLE,'\
            'STARTDATE_4,ENDDATE_4,DEMAND_4,SUMMER_CYCLE,BILL_CYCLE,'\
            'STARTDATE_5,ENDDATE_5,DEMAND_5,SUMMER_CYCLE,BILL_CYCLE,'\
            'STARTDATE_6,ENDDATE_6,DEMAND_6,SUMMER_CYCLE,BILL_CYCLE,'\
            'STARTDATE_7,ENDDATE_7,DEMAND_7,SUMMER_CYCLE,BILL_CYCLE,'\
            'CAPOBLIGSCALE,FINALRPMZONAL,FORECASTPOOLRESV,GENCAPSCALE,LOSSEXPANFACTOR,'\
            'CAPPROFPEAKRATIO,METER_TYPE,'\
            'CAPACITY_PLANNNG_YEAR,'\
            'PLC,'\
            'NITS'
